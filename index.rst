.. Skygrid documentation master file, created by
...
To get started, first check out the :doc:`concepts-guide`. The :doc:`up-and-running-in-five` guide will then step you through creating a project, device and simple application all through the Skygrid platform.
